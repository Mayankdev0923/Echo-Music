...
import iad1tya.echo.music.akai.updater.downloadmanager.UpdateDownloadWorker
import iad1tya.echo.music.akai.updater.downloadmanager.DownloadNotificationManager
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/AkaiApp/Akai/releases/download/${currentStatus.version}/akai.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/AkaiApp/Akai/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/AkaiApp/Akai/releases/download/$tagWithPrefix/changelog.json")
