...
This document provides instructions for setting up the Akai project for development.
...
Akai supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.
